...
module SmrfClient
  class RatesUniqueValuesPostRequest
    ...
    def hash
      [field, rate_source, billing_code, service_code, negotiation_arrangement, billing_class, entity_type, negotiated_supertype, zips, applicable_specialties, npi_specialties].hash
    end
