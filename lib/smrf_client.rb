...
require 'smrf_client/models/negotiated_supertype'
require 'smrf_client/models/negotiated_supertype_object'
...
require 'smrf_client/models/rates_unique_values_post_request_all_of'
